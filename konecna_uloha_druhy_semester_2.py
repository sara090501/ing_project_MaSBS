...
small_cell_type = oif.OifCellType(
                    nodes_file="Biclustersolid284nodes.dat",
                    triangles_file="Biclustersolid284triangles.dat",
...
with open("output/cells_positions1/smallCellPositions.csv", newline='') as csvfile:
...
print("Number of small cells: " + str(num_small_cells))

with open("output/cells_positions1/bigCellPositions.csv", newline='') as csvfile:
