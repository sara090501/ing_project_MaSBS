...
small_cell_type = oif.OifCellType(nodes_file="rbc482nodes.dat", triangles_file="rbc482triangles.dat",
...
big_cell_type = oif.OifCellType(nodes_file="rbc482nodes.dat", triangles_file="rbc482triangles.dat",
                                # hodnoty na vyratanie krviniek
                                check_orientation=False, system=system, ks=0.02, kb=0.016, kal=0.02,
