...
# --------------------------------------------------------------------------------------------------------------------------------------------------------
wall = num_small_cells + num_big_cells + 10
all_cells = num_small_cells + num_big_cells
# cell-wall interactions

# Nastavenie interakcií cell-wall pre malé bunky
for i in range(all_cells):
    system.non_bonded_inter[i, wall].soft_sphere.set_params(a=0.02, n=1.5, cutoff=1.0, offset=0.0)

# # Nastavenie interakcií cell-wall pre veľké bunky
# for i in range(num_big_cells):
#     system.non_bonded_inter[num_small_cells + i, wall].soft_sphere.set_params(a=0.02, n=1.5, cutoff=0.5, offset=0.0)
